...
import (
	...
	pb "gitlab.bianjie.ai/avata/chains/api/v2/pb/v2/contract"
...
type IContract interface {
	CreateCall(ctx context.Context, params dto.CreateContractCall) (*dto.TxRes, error)
	ShowCall(ctx context.Context, params dto.ShowContractCall) (*dto.ShowContractCallRes, error)
}
...
func (t *contract) CreateCall(ctx context.Context, params dto.CreateContractCall) (*dto.TxRes, error) {
	...
	grpcClient, ok := initialize.ContractClientMap[mapKey]
	if !ok {
...
func (t *contract) ShowCall(ctx context.Context, params dto.ShowContractCall) (*dto.ShowContractCallRes, error) {
	...
	result := &dto.ShowContractCallRes{
		Result: resp.Result,
	}
